...
<div class="con">
	<div class="container">
		<header class="header">
			...
			<a href="/login.php" class="btn transparent">Services</a>
			<a href="/login.php" class="btn transparent">About us</a>
			<div class="buttons">
		...
		<div class="container">
			...
			<div class="section-heading">
				...
				<div class="card-info">
							...
							<div class="category">Japanese Cusine </div>
						</div>	
			</div>
			<div class="cards">
				<div class="card wow fadeInUp" data-wow-delay="0.2s">
					...
					<div class="card-text">
						<div class="card-heading">
							<h3 class="card-title card-title-reg">Eel Roll Standard</h3>
						</div>
						<div class="card-info">
							<div class="ingredients">Rice, eel, unagi sauce, sesame, nori seaweed</div>
						</div>
				...
				<div class="card wow fadeInUp" data-wow-delay="0.4s">
					...
					<div class="card-text">
						<div class="card-heading">
							<h3 class="card-title card-title-reg">California Standard</h3>
						</div>
						<div class="card-info">
							<div class="ingredients">Rice, salmon, avocado, cucumber, mayonnaise, masago caviar, nori.</div>
						</div>
						<div class="card-buttons">
							<button class="button button-primary">
								<span class="button-card-text">Add To Cart</span> 
				...
				<div class="card wow fadeInUp" data-wow-delay="0.6s">
					...
					<div class="card-text">
						<div class="card-heading">
							<h3 class="card-title card-title-reg">Oikawa Standards</h3>
						</div>
						<div class="card-info">	
							<div class="ingredients">Rice, boiled shrimp, cream cheese, salmon, fresh cucumber</div>
						</div>
						<div class="card-buttons">
							<button class="button button-primary">
								<span class="button-card-text">Add To Cart</span> 
				...
				<div class="card wow fadeInUp" data-wow-delay="0.2s">
					...
					<div class="card-text">
						<div class="card-heading">
							<h3 class="card-title card-title-reg">Caesar Maci xl</h3>
						</div>
						<div class="card-info">
							<div class="ingredients">Rice, smoked chicken breast, masago caviar, tomato, iceberg, Caesar sauce</div>
						</div>
						<div class="card-buttons">
							<button class="button button-primary">
								<span class="button-card-text">Add To Cart</span> 
				...
				<div class="card wow fadeInUp" data-wow-delay="0.4s">
					...
					<div class="card-text">
						<div class="card-heading">
							<h3 class="card-title card-title-reg">Yasai maki standard 185 g</h3>
						</div>
						<div class="card-info">
							<div class="ingredients">Rice, fresh tomato, bell pepper, avocado, cucumber, iceberg</div>
						</div>
						<div class="card-buttons">
							<button class="button button-primary">
								<span class="button-card-text">Add To Cart</span> 
				...
				<div class="card wow fadeInUp" data-wow-delay="0.6s"> 
					...
					<div class="card-text">
						<div class="card-heading">
							<h3 class="card-title card-title-reg">Shrimp roll standard</h3>
						</div>
						<div class="card-info">
							<div class="ingredients">Rice, nori seaweed, boiled shrimp, cream cheese, cucumbers</div>
						</div>
						<div class="card-buttons">
							<button class="button button-primary">
								<span class="button-card-text">Add To Cart</span> 
